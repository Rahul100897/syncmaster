              ...
              {primaryConnected ? (
                <Box background="bg-surface-success" borderRadius="300" padding="500">
                  <BlockStack gap="100" inlineAlign="center">
                    ...
                    <Text as="p" tone="subdued">
                      Now syncing with {asPrimary?.secondaryShopId}
                    </Text>
                  </BlockStack>
                </Box>
              ) : (
                <>
                  <Text as="p" tone="subdued">
                    Use this as your main store. Share the code with the other
                  ...
                  <generateFetcher.Form method="post">
                    ...
                    >
                      {displayCode ? "Get a new code" : "Get connection code"}
                    </Button>
              ...
              {asSecondary ? (
                <Box background="bg-surface-success" borderRadius="300" padding="500">
                  <BlockStack gap="100" inlineAlign="center">
                    ...
                    <Text as="p" tone="subdued">
                      Main store: {asSecondary.primaryShopId}
                    </Text>
                  </BlockStack>
                </Box>
              ) : (
                <>
                  <Text as="p" tone="subdued">
                    Use this as your second store. Enter the 6-digit code from
                    your main store.
                  </Text>
